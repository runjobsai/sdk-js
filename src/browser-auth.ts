...
function mountActivityBadge(opts: MountOpts): HTMLButtonElement {
  ...
  let popoverHoverTimer: number | null = null;
  ...
  el.addEventListener("mouseenter", () => {
    if (popoverHoverTimer !== null) window.clearTimeout(popoverHoverTimer);
 ...
 */
function bindTrackerRedraw(tracker: ActivityTracker, redraw: () => void): void {
